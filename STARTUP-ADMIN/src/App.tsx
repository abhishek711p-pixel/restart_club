        ...
        <div className="container hero-container">
          ...
          <div className="hero-content">
            ...
            <div className="hero-social-proof">
              ...
              <div className="proof-item">
                <span className="proof-number">₹500/mo</span>
          ...
          <div className="why-grid">
            <div className="why-col">
              ...
              <p className="why-col-text">
                We understand that students need real human connections, but hiring a personal mentor is highly expensive. By using our AI assistant features to handle daily planners and doubt answering, we reduce human mentor workload by 80%—allowing us to offer dedicated mentor & guidance for just ₹500/month.
              </p>
            </div>
      ...
      <section className="math-value-section">
        <div className="container">
          <div className="math-value-header text-center">
            ...
            <h2 className="section-title">How Small is ₹500/month for Dedicated Mentor & Guidance?</h2>
            <p className="section-description max-w-2xl mx-auto">
          ...
          <div className="math-grid">
            <div className="math-card glass-card">
              ...
              <p className="math-card-desc">₹500/month is less than the cost of ordering a single medium pizza. Invest it in securing your dedicated mentor & guidance and AI guides instead.</p>
            </div>
            ...
            <div className="math-card glass-card">
              ...
              <p className="math-card-desc">A single daily travel auto/bus trip to coaching centers costs more than ₹500/month. Save travel time and resolve doubts comfortably from home.</p>
            </div>
            
            <div className="math-card glass-card">
              <span className="math-metric-highlight">0.05% of First Salary</span>
              <p className="math-card-desc">₹500 is a tiny fraction of your monthly salary after graduating from top IITs/NITs or government medical colleges.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <table className="comparison-matrix">
              <thead>
                <tr>
                  ...
                  <th className="highlight-col">RestartClub (AI + Mentor) (₹500)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                ...
                <tr>
                  ...
                  <td className="highlight-col"><Check className="table-icon green" size={20} /> <span className="highlight-text">₹500/mo</span></td>
                </tr>
              </tbody>
            </table>
          </div>
